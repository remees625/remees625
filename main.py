...
def addstudent():
    ...
    if request.method=="POST":
        ...
        query=db.engine.execute(f"INSERT INTO `student` (`rollno`,`sname`,`sem`,`gender`,`branch`,`email`,`number`,`address`,'fee_mode') VALUES ('{rollno}','{sname}','{sem}','{gender}','{branch}','{email}','{num}','{address}','{fee_mode}')")
